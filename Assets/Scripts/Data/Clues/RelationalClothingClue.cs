...
public class RelationalClothingClue : Clue
{
    ...
    {
        return $"{(subject1 == speaker ? "I am" : Character.GetNameDisplayName(subject1.name) + " is")} {(isNegated ? "not " : "")}wearing the same colour clothes as {(subject2 == speaker ? "me" : Character.GetNameDisplayName(subject2.name))}";
    }
